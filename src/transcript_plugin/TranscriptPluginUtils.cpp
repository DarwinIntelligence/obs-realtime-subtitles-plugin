...
#ifdef _WIN32
	source = obs_source_create("text_gdiplus_v3", "Darwin Realtime Subtitles", nullptr, nullptr);
#else
	source = obs_source_create("text_ft2_source_v2", "Darwin Realtime Subtitles", nullptr, nullptr);
#endif
	if (source) {
